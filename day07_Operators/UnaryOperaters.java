...
public class UnaryOperaters {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(c++); // post increment: fist passes the current value, then increases the value by 1
        ...
        System.out.println(y--); // post decrement: fist passes the current value, then decreases the value by 1
